...
//				// 쿼리문 작성 
//				// 데이터 가져오기 쿼리문 
//				String phonesql = "SELECT * from phoneInfo WHERE phoneName = 'iPhone XsM(512GB)' ";
//				String plansql = "SELECT * from planInfo WHERE operator = 'KT' ";	
//		
//				// 휴대폰 데이터 저장하기 쿼리문  
//				phonesql = "INSERT INTO phoneInfo(phoneName, company, phonePrice, screenSize, os, capacity, RAM, frontCamera, rearCamera, weight, phoneSize, betteryCapacity, speed, resolution, releaseYear, color, link) 
//							VALUES ('iphone', 'apple', '20000', '4.8', 'os', '512', '4', '700', '1200', '208', '112233', '3000', '2.5', 'resolution', '2018', 'gold', 'www.naver.com')";
//				// 요금제 데이터 저장하기 쿼리문 
//				plansql = "INSERT INTO plansql(operator, planName, mobile, planPrice, data, videoCall, call, message, option) 
//							VALUES ('KT', '화이팅요금제', 'LTE', '45000', '무제한', '무제한', '무제한', '무제한', '대학생 대상' )";
//				// 회원정보 데이터 저장하기 쿼리문  
//				String customersql = "INSERT INTO customerInfo(ID, password, name, age, phone_number, email_address, sex)
//										VALUES ('ID', 'password', 'name', 'age', 'phone_number', 'email_address', 'sex');
//
//				// 회원정보 데이터 삭제하기 쿼리문 
//				customersql = "DELETE FROM customerInfo WHERE ID = 'ID'";			
...
//				// 쿼리문 실행 
////			phoneResult = statement.executeQuery(phonesql);
//				planResult = statement.executeQuery(plansql);
//				customnerResult = statement.executeQuery(customersql);
//				
//				// 휴대폰 정보 검색 결과 출력 
////				while(phoneResult.next()) {
////					String phoneName = phoneResult.getString(1);
////					String company = phoneResult.getString(2);
////					int phonePrice = Integer.parseInt(phoneResult.getString(3));
////					double screenSize = Double.parseDouble(phoneResult.getString(4));
////					String os = phoneResult.getString(5);
////					int capacity = Integer.parseInt(phoneResult.getString(6));
////					int RAM = Integer.parseInt(phoneResult.getString(7));
////					int frontCamera = Integer.parseInt(phoneResult.getString(8));
////					int rearCamera = Integer.parseInt(phoneResult.getString(9));
////					int weight = Integer.parseInt(phoneResult.getString(10));
////					String phoneSize = phoneResult.getString(11);
////					int betteryCapacity = Integer.parseInt(phoneResult.getString(12));
////					double speed = Double.parseDouble(phoneResult.getString(13));
////					String resolution = phoneResult.getString(14);
////					int releaseYear = Integer.parseInt(phoneResult.getString(15));
////					String color = phoneResult.getString(16);
////					String link = phoneResult.getString(17);
////					int recCount = Integer.parseInt(phoneResult.getString(18));
////					
...
//					String operator = planResult.getString(1);
//					String planName = planResult.getString(2);
//					String mobile = planResult.getString(3);
//					int planPrice = Integer.parseInt(planResult.getString(4));
//					String data = planResult.getString(4);
//					String videoCall = planResult.getString(5);
//					String call = planResult.getString(6);
//					String message = planResult.getString(7);
//					String option = planResult.getString(8);
//					
					...
					for (i = 0; i < customerlist.size(); i++) {
						...
						if (str2.equals(customerlist.get(i).getID())) {
							...
							try {
								...
								String data[] = { newcustomner.getID(), newcustomer.getpassword, newcustomer.getname(),
												 newcustomer.getage(), newcustomer.getphone_number(), newcustomer.getemail_address(),
												 newcustomer.getsex()};
								database.setCustomDB(data);				
