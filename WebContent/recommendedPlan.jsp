					...
					<div class="pricing">
						...
						<div class="plan-body">
							<p class="mbr-text mbr-fonts-style display-7">
								...
								요금제<br>
								<br>월 데이터 :
								<%=firstPlan.getAmtOfData() %><br>월 전화 :
								<%=firstPlan.getCall() %><br>월 문자 :
					...
					<div class="pricing">
						...
						<div class="plan-body">
							<p class="mbr-text mbr-fonts-style display-7">
								...
								요금제<br>
								<br>월 데이터 :
								<%=secondPlan.getAmtOfData() %><br>월 전화 :
								<%=secondPlan.getCall() %><br>월 문자 :
					...
					<div class="pricing">
						...
						<div class="plan-body ">
							<p class="mbr-text mbr-fonts-style display-7">
								...
								요금제<br>
								<br>월 데이터 :
								<%=thirdPlan.getAmtOfData() %><br>월 전화 :
								<%=thirdPlan.getCall() %><br>월 문자 :
