...
<!-- Navigation -->
  ...
  <div class="container container-table">
      ...
      <h3 class="mbr-section-subtitle mbr-fonts-style align-center pb-5 mbr-light display-5"><strong>
            관리자 전용 페이지입니다.</strong></h3>
      <div class="table-wrapper">
        <div class="container">
        <div class="mbr-section-btn pt-4 text-center">
						<form action="addPlan.jsp" method="post">
        ...
        <div class="container scroll">
         ...
         while(result.next())
         {
             out.println("<tr><td class=\"body-item mbr-fonts-style display-7\">"+result.getString(1)+"</td>"
                     ...
                     +"<td>"
                    +"<form action = \"deletePlan.jsp\" method = \"post\"><input type = \"hidden\" name = \"planName\""
                    +"value = \""+result.getString(2)+"\">"
                    +"<input type = \"submit\" value = \"삭제\" class=\"body-item mbr-fonts-style display-7\"></form></tr>" 
                   ); 
         }
