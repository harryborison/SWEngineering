...
%>
        ...
        <div class="media-container-row">
            <div class=" col-12 col-lg-4 col-md-6 my-2">
                <div class="pricing">
                    ...
                    <div class="plan-body">
                        <p class="mbr-text mbr-fonts-style display-7">회사 : <%=firstPhone.company %><br>가격 : <%=p1 %>만원<br>용량 : <%=firstPhone.capacity%>GB<br></p>
                        <form action = "detailphone.jsp" method = "post"><input type = "hidden" name = "phoneName" value = "<%= firstPhone.phoneName%>"><div class="mbr-section-btn pt-4 text-center"><input type = "submit" value = "상세정보 보기" class="btn btn-primary display-4"></div>
                    	</form>
                    </div>
                </div>
            </div>
                ...
                <div class="pricing">
                    ...
                    <div class="plan-body">
                        <p class="mbr-text mbr-fonts-style display-7">
                            회사 : <%=secondPhone.company %><br>가격 : <%=p2 %>만원<br>용량 : <%=secondPhone.capacity%>GB
                        </p>
                        <form action = "detailphone.jsp" method = "post"><input type = "hidden" name = "phoneName" value = "<%= secondPhone.phoneName%>"><div class="mbr-section-btn pt-4 text-center"><input type = "submit" value = "상세정보 보기" class="btn btn-primary display-4"></div>
                    	</form>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-4 col-md-6 my-2">
                <div class="pricing">
                    ...
                    <div class="plan-body ">
                        <p class="mbr-text mbr-fonts-style display-7">
                          	  회사 : <%=thirdPhone.company %><br>가격 : <%=p3 %>만원<br>용량 : <%=thirdPhone.capacity%>GB
                        </p>
                        <form action = "detailphone.jsp" method = "post"><input type = "hidden" name = "phoneName" value = "<%= thirdPhone.phoneName%>"><div class="mbr-section-btn pt-4 text-center"><input type = "submit" value = "상세정보 보기" class="btn btn-primary display-4"></div>
                    	</form>
                    </div>
                </div>
            </div>
  ...
  <section class="engine"><a href="https://mobirise.info/v">free html templates</a></section><script src="assets5/web/assets/jquery/jquery.min.js"></script>
