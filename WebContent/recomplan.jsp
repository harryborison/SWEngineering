	...
	<div class="container">
		<div class="card card-register mx-auto mt-5">
			...
			<div class="card-body">
				...
				<form name="myform2" id="form2" action="RecomPlanServlet"
					method="post" onSubmit="return checkForm(this)">
					<div class="timeline-heading">
						<h4>Company(1개 이상 선택)</h4>
					</div>
					<input type="checkbox" id="c1" name="company" value="KT">KT&nbsp;
					<input type="checkbox" id="c2" name="company" value="LG U+">LG
					U+&nbsp; <input type="checkbox" id="c3" name="company" value="SKT">SKT&nbsp;<br>
					<br>
					...
					<input type="checkbox" id="t2" name="type" value="5G">5G&nbsp;<br>
					<br>

					<div class="timeline-heading">
						<h4>Price(자연수 입력)</h4>
					</div>
					<span class="fa-stack fa-2x"> <input class="form-control"
						type="text" id="minPr" name="minprice" placeholder="" required />
					</span><label for="username">원 &nbsp;&nbsp; ~&nbsp; &nbsp;</label> <span
						class="fa-stack fa-2x"> <input class="form-control"
						type="text" id="maxPr" name="maxprice" placeholder="" required />
					</span><label for="username">원</label>

					<div class="timeline-heading">
						<h4>Data</h4>
					</div>
					<input type="radio" id="d1" name="data" value="inf"
						onClick="Data_OnOff('inf');">무제한&nbsp; <input type="radio"
						id="d2" name="data" value="self" onClick="Data_OnOff('self');">직접입력&nbsp;
					<span class="fa-stack fa-2x"><input style="display: none;"
						class="form-control" type="text" id="da" name="dataAmount"
						value="0" required /></span> <label id="gb" style="display: none;"
						for="username">GB(소수점 입력 가능)</label><br>
					<br>


					<div class="timeline-heading">
						<h4>Option(1개 이상 선택)</h4>
					</div>
					<input type="checkbox" id="o1" name="option" value="soldier">군인&nbsp;
					<input type="checkbox" id="o2" name="option" value="nextmonth">이월요금제&nbsp;
					<input type="checkbox" id="o3" name="option" value="vip">vip
					멤버쉽&nbsp; <input type="checkbox" id="o4" name="option"
						value="feature">피쳐폰 전용&nbsp; <input type="checkbox"
						id="o5" name="option" value="notsee">시각장애인 전용&nbsp;<br>
					<input type="checkbox" id="o6" name="option" value="notlisten">청각장애인
					전용&nbsp; <input type="checkbox" id="o7" name="option"
						value="disabled">장애인 혜택 요금제&nbsp; <input type="checkbox"
						id="o8" name="option" value="old">65세 이상&nbsp; <input
						type="checkbox" id="o9" name="option" value="young">청소년
					요금제&nbsp;<br>
					<br> <input type="submit" value="추천 해주세요!"
