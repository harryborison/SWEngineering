 ...
 */
	...
	public void testMatchcompany() {
		...
		String[] organitype1 = new String[1];
		organitype1[0] = "Apple";

		String[] organitype2 = new String[1];
		organitype2[0] = "Samsung";
		
		String[] organitype3 = new String[1];
		organitype3[0] = "LG";
		
		String[] organitype4 = new String[1];
		organitype4[0] = "»þ¿À¹Ì";
		
		String[] organitype5 = new String[1];
		organitype5[0] = "NULL";
		
		assertEquals(3, rec.matchcompany("Apple",organitype1));
		assertEquals(0, rec.matchcompany("Apple",organitype2));
		assertEquals(0, rec.matchcompany("Apple",organitype3));
		assertEquals(0, rec.matchcompany("Apple",organitype4));
		assertEquals(0, rec.matchcompany("Apple",organitype5));
		
		assertEquals(0, rec.matchcompany("Samsung",organitype1));
		assertEquals(3, rec.matchcompany("Samsung",organitype2));
		assertEquals(0, rec.matchcompany("Samsung",organitype3));
		assertEquals(0, rec.matchcompany("Samsung",organitype4));
		assertEquals(0, rec.matchcompany("Samsung",organitype5));
		
		assertEquals(0, rec.matchcompany("LG",organitype1));
		assertEquals(0, rec.matchcompany("LG",organitype2));
		assertEquals(3, rec.matchcompany("LG",organitype3));
		assertEquals(0, rec.matchcompany("LG",organitype4));
		assertEquals(0, rec.matchcompany("LG",organitype5));
		
		assertEquals(0, rec.matchcompany("»þ¿À¹Ì",organitype1));
		assertEquals(0, rec.matchcompany("»þ¿À¹Ì",organitype2));
		assertEquals(0, rec.matchcompany("»þ¿À¹Ì",organitype3));
		assertEquals(3, rec.matchcompany("»þ¿À¹Ì",organitype4));
		assertEquals(0, rec.matchcompany("»þ¿À¹Ì",organitype5));
